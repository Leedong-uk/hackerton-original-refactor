    ...
    public SecurityFilterChain filterChain (HttpSecurity http, JwtUsernamePasswordAuthenticationFilter jwtUsernamePasswordAuthenticationFilter) throws Exception {
        ...
        http
                .authorizeHttpRequests((auth)-> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/auth/member-info").hasRole("USER")
                        .requestMatchers(HttpMethod.PATCH,"/auth/member-info").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/password").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/home").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/announce/**").hasRole("USER")
                        .requestMatchers( "/kakao-login/**").permitAll()
                        .requestMatchers("/articles/list").hasRole("USER")
                        ...
                        .requestMatchers("/sos/**").hasRole("USER")
                        .requestMatchers("/profile-image/**").hasRole("USER")
